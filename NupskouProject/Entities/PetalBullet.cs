    ...
    public abstract class PetalBullet : StdEntity {
        ...
        public override void Render () {
            _.Renderer.TestForeground.Add (
                new Sprite (_.Assets.Petal) {Position = P, Color = BorderColor, Scale = new Vector2 (R + 1)},
                new Sprite (_.Assets.Petal) {Position = P, Color = MainColor,   Scale = new Vector2 (R + 0.5f)},
                new Sprite (_.Assets.Petal) {Position = P, Color = Color.White, Scale = new Vector2 (R)}
            );
        }
