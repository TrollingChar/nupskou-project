...
namespace NupskouProject.Stages.Enemy {
    ...
    public class EnemyMastirStage1Encounter1 : Entities.Enemy
    {
        ...
        protected override void Update(int t)
        {
            ...
            if(t > _t)
            P = new XY(_p.X + 100 * Mathf.Cos (-Mathf.PI/2 - (t - _t) * Mathf.PI/_spindelay) * _side,_p.Y + 100 * Mathf.Sin(-Mathf.PI/2 - (t - _t) * Mathf.PI/_spindelay * _side) );
            ...
            if (_shoot && t % 90 == 0)
            {
                _.World.Spawn(new LinearRoundBullet(
                    P,
